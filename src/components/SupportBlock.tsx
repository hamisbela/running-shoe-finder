  ...
  return (
    <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-8 text-center">
      <div className="max-w-2xl mx-auto">
        ...
        <h2 className="text-3xl font-bold text-green-500 mb-4">Support Our Work ❤️</h2>
        <p className="text-gray-700 mb-6">
          Help us maintain and improve our free running shoe finder by image tool by supporting us.
          Your contribution helps keep this tool free for all runners who want to identify shoes and find where to buy them! 👟
        </p>
        <a
